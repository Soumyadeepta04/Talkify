...
import { acceptFriendRequest, getFriendRequests, rejectFriendRequest } from "../lib/api.js";
                                    ...
                                    <section>
                                        ...
                                        <div className='space-y-3'>
                                            {incomingRequests.map((request) => (
                                                <div
                                                    key={request._id}
                                                    className='card bg-base-200/50 border border-base-300/50 shadow-sm hover:shadow-lg hover:border-primary/50 transition-all duration-300 ease-in-out'
                                                >
